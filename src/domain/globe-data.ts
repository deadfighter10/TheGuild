...
export function aggregateUsersByCountry(
  users: readonly UserWithCountry[],
): Map<string, number> {
...
export const COUNTRY_COORDS: Record<string, CountryCoordinates> = {
  "Afghanistan": { lat: 33.93, lng: 67.71 },
  "Albania": { lat: 41.15, lng: 20.17 },
  "Algeria": { lat: 28.03, lng: 1.66 },
  "Andorra": { lat: 42.55, lng: 1.60 },
