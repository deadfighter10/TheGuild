...
export function HourglassIcon({ size = 20, className = "" }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M5 4h14M5 20h14M7 4v3a5 5 0 005 5 5 5 0 005-5V4M7 20v-3a5 5 0 015-5 5 5 0 015 5v3" />
    </svg>
  )
}
...
export function DnaIcon({ size = 20, className = "" }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export function TreeIcon({ size = 20, className = "" }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M12 22V8M5 12l7-7 7 7" />
      <path d="M2 17l5-5M22 17l-5-5" />
...
export function AdvancementIcon({ icon, ...props }: IconProps & { readonly icon: string }) {
  const IconComponent = ICON_MAP[icon] ?? ZapIcon
